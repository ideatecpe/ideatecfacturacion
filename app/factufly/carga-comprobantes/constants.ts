...
> = {
  ...
  trimestral:     { label: "Trimestral",     activeClass: "bg-fuchsia-600 text-white shadow-sm",idleClass: "text-fuchsia-700 hover:bg-fuchsia-50", badgeClass: "bg-fuchsia-100 text-fuchsia-700", dotClass: "bg-fuchsia-400", borderClass: "border-fuchsia-200", bgCard: "bg-fuchsia-50" },
  ...
  "7meses":       { label: "Septemestral",   activeClass: "bg-yellow-500 text-white shadow-sm", idleClass: "text-yellow-700 hover:bg-yellow-50",   badgeClass: "bg-yellow-100 text-yellow-700",   dotClass: "bg-yellow-400",  borderClass: "border-yellow-200",  bgCard: "bg-yellow-50"  },
  ...
  anual:          { label: "Anual",          activeClass: "bg-green-600 text-white shadow-sm",  idleClass: "text-green-700 hover:bg-green-50",     badgeClass: "bg-green-100 text-green-700",     dotClass: "bg-green-500",   borderClass: "border-green-200",   bgCard: "bg-green-50"   },
