...
const opcionesBase = [
  { title: 'Listado de Productos', desc: 'Administra tu catálogo: registro, edición, precios y stock.', icon: Package, href: '/factufly/productos/lista' },
];

const opcionesStock = [
  { title: 'Kardex', desc: 'Historial de entradas y salidas valorizadas por producto (PEPS).', icon: Boxes, href: '/factufly/productos/kardex' },
  { title: 'Stock Valorizado', desc: 'Valor actual del inventario según el costo de sus lotes de compra.', icon: DollarSign, href: '/factufly/productos/stockValorizado' },
  { title: 'Rentabilidad', desc: 'Utilidad bruta por producto según el costo PEPS de cada venta.', icon: TrendingUp, href: '/factufly/productos/rentabilidad' },
];
...
export default function ProductosPage() {
  ...
  const opciones = config?.isStock ? [...opcionesBase, ...opcionesStock] : opcionesBase;
