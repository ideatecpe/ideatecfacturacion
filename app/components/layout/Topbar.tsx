...
function YapeToast({
  ...
  useEffect(() => {
    ...
    // Espera a que la animación salida termine antes de limpiar
  ...
  return (
    <div
      ...
      className="w-85 max-w-[calc(100vw-2rem)]"
    >
      <div
        className="rounded-b-2xl overflow-hidden"
        style={{
          background: "linear-gradient(135deg, #5B0FAA 0%, #8B2BE2 100%)",
          boxShadow:
            "0 8px 32px rgba(109,31,202,0.45), 0 2px 8px rgba(0,0,0,0.18)",
        }}
      >
        ...
        <div className="px-4 py-3 flex items-center gap-3.5">
          ...
          {/* Decoración derecha */}
          <div className="shrink-0 flex flex-col items-end gap-1 opacity-30">
...
export const Topbar = ({
  ...
  return (
    <>
        ...
        <div className="h-14 flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`p-2.5 rounded-xl relative group transition-all ${
                  isBeta
                    ...
                    : "hover:bg-white text-slate-400 hover:text-brand-blue"
                }`}
              >
                <Bell
            ...
            <div className="relative" ref={userRef}>
              ...
              {userOpen && (
                <div className="fixed sm:absolute inset-x-2 sm:inset-x-auto sm:right-0 top-15 sm:top-auto sm:mt-2 sm:w-56 bg-white rounded-2xl shadow-xl overflow-hidden z-50 animate-fade-in">
      ...
      <YapeToast alert={yapeAlert} onDismiss={dismissYape} />
